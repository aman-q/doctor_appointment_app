...
function CancelAppointment({onContinueClick}) {
  ...
  return (
    <AlertDialog>
    <AlertDialogTrigger>
    <Button variant="outline" className="text-primary border-primary hover:bg-red-700 hover:text-white hover:border-red-700  transition-all ease-in-out">Cancel Appointment</Button>
    </AlertDialogTrigger>
    <AlertDialogContent>
      <AlertDialogHeader>
